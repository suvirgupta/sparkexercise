...
rdd_orders.map(lambda x: (None, x)).saveAsNewAPIHadoopFile("/user/cloudera/problem5/sequence_newAPI1","org.apache.hadoop.mapreduce.lib.output.SequenceFileOutputFormat", keyClass = "org.apache.hadoop.io.NullWritable",valueClass = "org.apache.hadoop.io.ArrayWritable" )
...
### store orc file from the sequence file

rdd_seq_ord = sc.sequenceFile("/user/cloudera/problem5/sequence")
